    ...
    <script>
    	function submitData() {
    		...
    		if(title==null || title=="") {
    			...
    			$.post("${pageContext.request.contextPath}/admin/blog/save.action",{'title':title,'blogType.id':blogTypeId,'content':content,'summary':UE.getEditor('editor').getContentTxt().substr(0,155)},function(result){
        			if(result.success) {
        				alert("博客发布成功!");
        				resetValue();
        			}else {
